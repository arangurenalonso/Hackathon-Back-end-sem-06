...
class Connection:
    ...
    def get_by_id(self, id_object): #Metodo que me traiga la data por ID
        query = f'''
        ...
        print("".join(map(str, id_object.keys())))
        print("".join(map(str, id_object.values()))) 
